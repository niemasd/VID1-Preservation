...
If a `.flac` file had lots of audio after the end of the `.vid` file (e.g. a cutscene that transitions from `.vid` FMV to in-engine), I used the following command to trim the `.flac` file:
